...
Loc::getLoc() const {
    switch (kind) {
    case Kind::Decl:	return getDeclLoc(*u.decl);
    case Kind::Stmt:	return u.stmt->getBeginLoc();
    case Kind::TypeLoc:	return u.typeloc->getBeginLoc();
    case Kind::Tsi:	return u.tsi->getTypeLoc().getBeginLoc();
    case Kind::QualType:
    case Kind::Type:	return invalid_loc;
    case Kind::Tal:	return u.tal->getSourceRange().getBegin();
    }
}
