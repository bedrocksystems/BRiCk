...
Require Import bedrock.lang.ast.
Require Import bedrock.lang.notations.
Require Import bedrock.lang.code_notations.
  ...
  Let stmt3 : Stmt :=
    (Sseq (
              [ Sif
                ...
                (Ecast Cint2bool
                    (Ecast Cl2r (Evar "x" (Qmut Ti32)) Prvalue (Qmut Ti32)) Prvalue (Qmut Tbool))
  ...
  Let stmt6 : Stmt :=
    Sseq (
                (Sif
                  ...
                  (Sseq (
                      (Sexpr
                        (Epostinc (Evar "x" (Qmut Ti32)) (Qmut Ti32))) :: nil))
                  Scontinue) ::
                nil
    ).
  Print stmt6.
  ...
  Let stmt7 : Stmt :=
    Sseq (
                (Sif
                  ...
                  (Sseq (
                      (Sexpr
                        (Epredec (Evar "x" (Qmut Ti32)) (Qmut Ti32))) :: nil))) ::
                (Swhile
                  (Some (Dvar "x" (Qmut Ti32) (Some (Eint (0) (Qmut Ti32)))))
                  (Ecast Cint2bool
                      (Ecast Cl2r (Evar "x" (Qmut Ti32)) Prvalue (Qmut Ti32)) Prvalue (Qmut Tbool))
                  (Sseq (
                      (Sexpr
                        (Epostdec (Evar "x" (Qmut Ti32)) (Qmut Ti32))) :: nil))) :: nil).
  Print stmt7.
  ...
  Let stmt8 : Stmt :=
    Sseq (
           (Sdo
              (Sseq (
                   (Sexpr
                          (Epostdec (Evar "x" (Qmut Ti32)) (Qmut Ti32))) :: nil))
              (Ecast Cl2r (Evar "x" (Qmut Ti32)) Prvalue (Qmut Ti32))
           ) :: nil).
  Print stmt8.
