...
Section with_Σ.
  ...
  Lemma wp_unreachable : forall Q,
      False |-- BUILTIN Bin_unreachable (Tfunction CC_C Tvoid nil) nil Q.
  Proof. intros. iIntros "[]". Qed.

  Lemma wp_trap : forall Q,
      False |-- BUILTIN Bin_trap (Tfunction CC_C Tvoid nil) nil Q.
  Proof. intros. iIntros "[]". Qed.

  Axiom wp_expect : forall exp c Q,
      Q exp |-- BUILTIN Bin_expect (Tfunction CC_C (Tint W64 Signed) (Tint W64 Signed :: Tint W64 Signed :: nil)) (exp :: c :: nil) Q.
  ...
  Axiom wp_ffs : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffs (Tfunction CC_C (Tint sz Signed) (Tint sz Signed :: nil)) (Vint c :: nil) Q.

  Axiom wp_ffsl : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffsl (Tfunction CC_C (Tint sz Signed) (Tint sz Signed :: nil)) (Vint c :: nil) Q.

  Axiom wp_ffsll : forall sz c Q,
          ffs_spec sz c Q
      |-- BUILTIN Bin_ffsll (Tfunction CC_C (Tint sz Signed) (Tint sz Signed :: nil)) (Vint c :: nil) Q.
  ...
  Axiom wp_ctz : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctz (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.

  Axiom wp_ctzl : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctzl (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.

  Axiom wp_ctzll : forall sz c Q,
          ctz_spec sz c Q
      |-- BUILTIN Bin_ctzll (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.
  ...
  Axiom wp_clz : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clz (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.

  Axiom wp_clzl : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clzl (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.

  Axiom wp_clzll : forall sz c Q,
          clz_spec sz c Q
      |-- BUILTIN Bin_clzll (Tfunction CC_C (Tint sz Unsigned) (Tint sz Unsigned :: nil)) (Vint c :: nil) Q.
  ...
  Axiom wp_bswap16 : forall x Q,
      ...
      |-- BUILTIN Bin_bswap16 (Tfunction CC_C (Tint W16 Unsigned) (Tint W16 Unsigned :: nil))
          (Vint x :: nil) Q.

  Axiom wp_bswap32 : forall x Q,
          [| has_type (Vint x) (Tint W32 Unsigned) |] ** Q (Vint (bswap W32 x))
      |-- BUILTIN Bin_bswap32 (Tfunction CC_C (Tint W32 Unsigned) (Tint W32 Unsigned :: nil))
          (Vint x :: nil) Q.

  Axiom wp_bswap64 : forall x Q,
          [| has_type (Vint x) (Tint W64 Unsigned) |] ** Q (Vint (bswap W64 x))
      |-- BUILTIN Bin_bswap64 (Tfunction CC_C (Tint W64 Unsigned) (Tint W64 Unsigned :: nil))
          (Vint x :: nil) Q.

  Axiom wp_bswap128 : forall x Q,
          [| has_type (Vint x) (Tint W128 Unsigned) |] ** Q (Vint (bswap W128 x))
      |-- BUILTIN Bin_bswap128 (Tfunction CC_C (Tint W128 Unsigned) (Tint W128 Unsigned :: nil))
          (Vint x :: nil) Q.
