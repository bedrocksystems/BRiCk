  ...
  Section with_resolve.
    ...
    Axiom wp_lval_preinc : forall e ty Q,
        ...
        | Some cty =>
          wp_lval e (fun a free => Exists v', Exists v'',
              ...
              ( [| eval_binop_pure Badd (erase_qualifiers (type_of e)) cty (erase_qualifiers ty) v' (Vint 1) v'' |] **
    ...
    Axiom wp_lval_predec : forall e ty Q,
        ...
        | Some cty =>
          wp_lval e (fun a free => Exists v', Exists v'',
              _at (_eqv a) (primR (erase_qualifiers ty) 1 v') **
              ([| eval_binop_pure Bsub (erase_qualifiers (type_of e)) cty (erase_qualifiers ty) v' (Vint 1) v'' |] **
               (_at (_eqv a) (primR (erase_qualifiers ty) 1 v'') -* Q a free)))
        | None => lfalse
        end
    ...
    Axiom wp_prval_binop : forall o e1 e2 ty Q,
        ...
        wp_prval e1 Ql ** wp_prval e2 Qr **
            Forall v1 v2 free1 free2, Ql v1 free1 -* Qr v2 free2 -*
               Exists v',
                 [| eval_binop_pure o (erase_qualifiers (type_of e1)) (erase_qualifiers (type_of e2)) (erase_qualifiers ty) v1 v2 v' |] **
                 Q v' (free1 ** free2))
