...
Notation "'boolR' q v" := (@primR _ _ Tbool q%Qp (Vbool v)) (at level 10, q at level 1, v at level 1).

(* integers with implicit sizes *)
(* note(gmm): these might need to become definitions if we want to be generic
 * across sizes
 *)
Notation "'scharR' q v" := (@primR _ _ (Tchar W8 Signed) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'ucharR' q v" := (@primR _ _ (Tchar W8 Unsigned) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'charR' q v" := (ucharR q v) (at level 10, q at level 1, v at level 1).

Notation "'sshortR' q v" := (@primR _ _ (Tint W16 Signed) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'ushortR' q v" := (@primR _ _ (Tint W16 Unsigned) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'shortR' q v" := (sshortR q v) (at level 10, q at level 1, v at level 1).


Notation "'sintR' q v" := (@primR _ _ (Tint int_bits Signed) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'uintR' q v" := (@primR _ _ (Tint int_bits Unsigned) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'intR' q v" := (sintR q v) (at level 10, q at level 1, v at level 1).

Notation "'slongR' q v" := (@primR _ _ (Tint long_bits Signed) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'ulongR' q v" := (@primR _ _ (Tint long_bits Unsigned) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'longR' q v" := (slongR q v) (at level 10, q at level 1, v at level 1).

Notation "'slonglongR' q v" := (@primR _ _ (Tint W64 Signed) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
Notation "'ulonglongR' q v" := (@primR _ _ (Tint W64 Unsigned) q%Qp (Vint v%Z)) (at level 10, q at level 1, v at level 1).
