 ...
 * across sizes
 *)
Notation "'scharR' q v" := (@primR _ _ _ (Tschar) q (Vint v)) (at level 10, q at level 1, v at level 1).
Notation "'ucharR' q v" := (@primR _ _ _ (Tuchar) q (Vint v)) (at level 10, q at level 1, v at level 1).
Notation "'charR' q v" := (ucharR q v) (at level 10, q at level 1, v at level 1).

Notation "'sshortR' q v" := (@primR _ _ _ (Tint W16 Signed) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'ushortR' q v" := (@primR _ _ _ (Tint W16 Unsigned) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'shortR' q v" := (sshortR q v) (only parsing, at level 10, q at level 1, v at level 1).


Notation "'sintR' q v" := (@primR _ _ _ (Tint int_bits Signed) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'uintR' q v" := (@primR _ _ _ (Tint int_bits Unsigned) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'intR' q v" := (sintR q v) (only parsing, at level 10, q at level 1, v at level 1).

Notation "'slongR' q v" := (@primR _ _ _ (Tint long_bits Signed) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'ulongR' q v" := (@primR _ _ _ (Tint long_bits Unsigned) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'longR' q v" := (slongR q v) (only parsing, at level 10, q at level 1, v at level 1).

Notation "'slonglongR' q v" := (@primR _ _ _ (Tint W64 Signed) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
Notation "'ulonglongR' q v" := (@primR _ _ _ (Tint W64 Unsigned) q (Vint v)) (only parsing, at level 10, q at level 1, v at level 1).
