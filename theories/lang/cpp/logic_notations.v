...
Module Verbose.
Notation "'::wpL' { e } Q" := (@wp_lval _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpX' { e } Q" := (@wp_xval _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpPR' { e } Q" := (@wp_prval _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpPRᵢ' { e } Q" := (@wp_init _ _ _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpGL' { e } Q" := (@wp_glval _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpR' { e } Q" := (@wp_rval _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpS' { e } Q" := (@wp _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
Notation "'::wpE' { e } Q" := (@wpe _ _ _ _ e Q)
         (at level 0, Q at level 200, only printing).
