...
public:
	void
	printDecl (const clang::Decl* d, CoqPrinter& print);

	void
	printParam (const clang::ParmVarDecl* d, CoqPrinter& print);

	void
	printLocalDecl (const clang::Decl* d, CoqPrinter& print);

	void
	printStmt (const clang::Stmt* s, CoqPrinter& print);

	void
	printType (const clang::Type* t, CoqPrinter& print);

	void
	printExpr (const clang::Expr* d, CoqPrinter& print);
