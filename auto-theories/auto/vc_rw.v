...
Ltac simplify_wp_ e :=
  ...
  | Sreturn (Some (Lvalue, ?e)) => rewrite <- Lemmas.wp_return_lval; try (simplify_simpl; simplify_wp_lval e)
  | Sreturn (Some (Rvalue, ?e)) => rewrite <- Lemmas.wp_return_rval; simpl is_aggregate; try (simplify_simpl; simplify_wp_prval e)
...
Ltac simplifying :=
  let with_context := idtac;
      ...
      | |- _ |-- ?R =>
        ...
        (* | context [ wp_prval _ _ (Econstructor _ _ _) _ ] => *)
